...
def get_session_manager():
    """Return the MCP session manager, resetting its single-use guard.

    The SDK's StreamableHTTPSessionManager only allows .run() once.
    We reset its internal flag so each app lifespan gets a clean start.
    """
