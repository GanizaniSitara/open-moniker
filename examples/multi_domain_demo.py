...
def run_demo():
    ...
    try:
        # Describe the domain
        info = client.describe("fixed.income/govies/treasury")
        ...
        data = client.read("fixed.income/govies/treasury/US/10Y/ALL")
    ...
    try:
        ...
        # Load data
        treasury_data = client.read("fixed.income/govies/treasury/US/10Y/ALL")
    ...
    domains = ["fixed.income/govies/treasury", "commods.energy", "rates.swap", "mortgages.pools"]
